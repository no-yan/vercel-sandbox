const Explainer = (): JSX.Element => (
  <div className="w-9/12">
    <h2 className="underline text-2xl">リバーシ</h2>
    <div className="mx-2 pt-2">
      <p>リバーシです。React/TypeScriptを学ぶため作成しました。</p>
      <p>手番パス・ゲーム終了条件の実装に時間を掛けています。</p>

      <div>
        <h3 className="pt-3 text-pink-800 text-lg">アルゴリズム</h3>
        <p>
      ...
      <div>
        <h3 className="pt-3 text-pink-800 text-lg">パフォーマンスと設計</h3>
        <p>
          Reactのパフォーマンスチューニング（メモ化）で再レンダリングを抑えています。
        </p>
      </div>
    </div>
    <p className="pt-10 underline font-sans text-2xl">使用技術</p>
